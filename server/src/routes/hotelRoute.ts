...
import { CreateHotel, GetAllHotels, GetAllUserHotels, GetUserHotelById, UpdateHotel } from '../controllers/hotel.ctrl';
...
hotelRoutes.get("/:id", AuthMiddleware, GetUserHotelById);

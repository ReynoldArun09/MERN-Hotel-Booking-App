...
export const GetAllHotels = AsyncWrapper(async (req: Request, res: Response) => {
  const hotels = await Hotel.find().sort("-lastUpdated");
  res.json(hotels);
});

export const GetAllUserHotels = AsyncWrapper(async (req: Request, res: Response) => {
...
export const GetUserHotelById = AsyncWrapper(async (req: Request, res: Response) => {
...
export const GetHotelById = AsyncWrapper(async (req: Request, res: Response) => {
  const id = req.params.id;
  const hotel = await Hotel.findById(id);
  res.json(hotel);
});

export const MyBookings = AsyncWrapper(async (req: Request, res: Response) => {

...
export const SearchContext = createContext<SearchContexType | undefined>(undefined);
...
export const SearchContextProvider = ({children}: {children:React.ReactNode}) => {
    ...
    return <SearchContext.Provider value={{destination, checkIn, checkOut, adultCount, childCount, saveSearchValues, hotelId}}>
        {children}
...
export const useSearchContext = () => {
    ...
    return context as SearchContexType
}
